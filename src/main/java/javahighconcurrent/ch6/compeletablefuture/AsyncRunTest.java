...
public class AsyncRunTest {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<Void> future1 = CompletableFuture.runAsync(() -> System.out.println(Thread.currentThread().getName()));
        System.out.println(future.get());
        System.out.println(future1.get());//null ;runAsync父类的返回类型是Void
    }
}
